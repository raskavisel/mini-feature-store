...
🚀 Project Overview:
This is a lightweight, production-inspired feature store for machine learning pipelines. It allows you to store, version, and retrieve features efficiently, supporting both training and inference workflows.
